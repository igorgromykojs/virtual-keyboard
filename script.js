...
fn.addEventListener('click', () => {
  document.querySelectorAll(".rus").toggleClass('hidden');
  document.querySelectorAll(".eng").toggleClass('hidden');
});
document.addEventListener ('keydown', () => {
